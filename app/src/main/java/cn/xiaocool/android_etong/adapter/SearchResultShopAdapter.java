 ...
 */
public class SearchResultShopAdapter extends BaseAdapter {
    ...
    public SearchResultShopAdapter(Context context, List<Local> locals) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.activity_hotel_item, null);

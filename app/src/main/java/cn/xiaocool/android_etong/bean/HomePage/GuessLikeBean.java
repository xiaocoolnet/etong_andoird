...
public class GuessLikeBean {
    ...
    private List<GuessLikeDataBean> data;
    ...
    public List<GuessLikeDataBean> getData() {
        return data;
    }

    public void setData(List<GuessLikeDataBean> data) {
        this.data = data;
    }

    public static class GuessLikeDataBean {
        private String id;

package cn.xiaocool.android_etong.view.list;
...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mHeaderTimeView.setVisibility(View.INVISIBLE);
        mHeaderTimeViewTitle.setVisibility(View.GONE);
        mHeaderTimeView.setVisibility(View.GONE);

        mArrowImageView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);

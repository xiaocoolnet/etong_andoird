...
//                    Log.e("result= ",result);
    ...
    //发布商品
    public void  npublishgoods(final String shopid, final String pic1, final String pic2, final String pic3, final String pic4, final String pic5, final String goodsname,
